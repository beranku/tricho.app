...
## Purpose
Single source of truth for the multilanguage architecture: locale registry, message-catalog format, Paraglide compiler integration, runtime API, anti-flash bootstrap, and the determinism contract for per-locale format helpers. New capability introduced by the i18n-multilocale-support change.
